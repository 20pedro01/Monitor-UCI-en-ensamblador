; =============================================================================
; ARCHIVO DE EVALUACIÓN E INTERFAZ: eval_int.asm (32 bits)
...
; Helper para imprimir con color (cambia color de consola, escribe la cadena y restaura el color por defecto)
ImprimirConColor PROC
    push eax
    movzx eax, bl
    call SetTextColor
    call WriteString
    mov eax, 7          ; Restaurar a gris claro por defecto
    call SetTextColor
    pop eax
    ret
...
IntToString3 PROC
    ...
    add dl, '0'
    mov [edi+2], dl     ; Unidades

    xor edx, edx
    div ebx             ; EAX = Cociente, EDX = Decenas
    add dl, '0'
    mov [edi+1], dl     ; Decenas
